...
echo "2. Start dev environment: docker compose -f docker/docker-compose.dev.yml up -d"
echo "3. View logs: docker compose -f docker/docker-compose.dev.yml logs -f"
