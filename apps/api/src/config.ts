...
export const config = {
  ...
  limits: {
    maxCardSizeMB: parseInt(process.env.MAX_CARD_SIZE_MB || '100', 10),
    maxPngSizeMB: parseInt(process.env.MAX_PNG_SIZE_MB || '100', 10),
    warnPngSizeMB: parseInt(process.env.WARN_PNG_SIZE_MB || '50', 10),
    warnCardSizeMB: parseInt(process.env.WARN_CARD_SIZE_MB || '25', 10),
  },
  sillyTavern: {
